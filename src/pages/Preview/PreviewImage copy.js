...
const Three = ({img_url, width, height, containerWidth, containerHeight}) => {
  ...
  function init() {
    ...
    img_plane.crossOrigin = "Anonymous";
    img_plane.src = "https://nft-cdn.alchemy.com/eth-mainnet/05a38bc11e52257d467ec940e5ffad79"
    ...
    img_plane.onload = function() {
        ...
        const mesh_plane = new THREE.Mesh(new THREE.PlaneGeometry(50, 50, 1),
          new THREE.MeshLambertMaterial({ map: texture_plane }))

//     var texture = new THREE.Texture( img_plane );
...
//     const geometry_plane = new THREE.PlaneGeometry(50, 50, 1);
// const mesh_plane = new THREE.Mesh(geometry_plane,
//     new THREE.MeshLambertMaterial({ map: texture_plane }))
//     mesh_plane.position.set(0, 30, 1.1);
// scene.add(mesh_plane);
    ...
    //   bumpScale: 0.0005
    // });
    // const textureLoader_1 = new TextureLoader();
    // textureLoader_1.load(
    //   img_url, function ( map ) {
    //     map.wrapS = THREE.RepeatWrapping;
    //     map.wrapT = THREE.RepeatWrapping;
    //     map.anisotropy = 4;
    //     map.repeat.set( 1, 1 );
    //     map.encoding = THREE.sRGBEncoding;
    //     material_1.roughnessMap = map;
    //     material_1.needsUpdate = true;
    //   } 
    // );
    // const mesh_1 = new Mesh(geometry_1, material_1);
